...
struct DarkwingDuckTheme {
    ...
    static let _gray250 = UIColor(red: 0.16 * 1.02, green: 0.16, blue: 0.16 * 1.05, alpha: 1.0)
    static let _gray200 = UIColor(red: 0.12 * 1.02, green: 0.12, blue: 0.12 * 1.05, alpha: 1.0)
    static let _gray150 = UIColor(red: 0.09 * 1.02, green: 0.09, blue: 0.09 * 1.05, alpha: 1.0)
    static let _gray100 = UIColor(red: 0.05 * 1.02, green: 0.05, blue: 0.05 * 1.05, alpha: 1.0)
    static let _gray050 = UIColor(red: 0.015 * 1.02, green: 0.015, blue: 0.015 * 1.05, alpha: 1.0)
    
    static let naughtyYellow = Color(uiColor: Self._naughtyYellow)
    static let silkyBlue = Color(uiColor: Self._silkyBlue)
    ...
    static let gray250 = Color(uiColor: Self._gray250)
